            ...
            <div className="flex flex-row">
                ...
                <div className="flex flex-col justify-center">
                    <label htmlFor='language-select'
                        ...
                        <select className='bg-transparent font-medium w-32 px-4 focus:outline-none' name="language-select" id="language-select">
                ...
                <div className="flex flex-col justify-center">
                    <button
                        className="hover-blue font-medium ml-10 text-xl text-white border-2 border-white rounded-3xl w-186 h-50 py-1 transition duration-200 ease-in-out">
                        Sign up / login
                    </button>
                </div>
            </div>
